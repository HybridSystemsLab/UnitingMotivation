...
% global variables
global delta M gamma lambda c_0 c_10 z1Star zeta cTilde_0 cTilde_10 d_0 d_10 alpha 
...
hold on
semilogy(tUniting2,lUniting2,'Color',[0.6350 0.0780 0.1840],'LineWidth',3);
semilogy(tHBF,lHBF,'Color',[0.4660 0.6740 0.1880],'LineWidth',3);
semilogy(tNest,lNest,'Color',[0.4940 0.1840 0.5560],'LineWidth',3,'LineStyle','--');
semilogy(tNest,10.^(yO(:,1)),'k--','LineWidth',3);
hold off
axis([0 6 10^(-20) 10^(6)]);
ylabel('$\mathrm{L(z_1)-L^*}$','FontSize',20)
